				...
				<div class="panel panel-primary">
						    	...
						    	<div class="row">
						    		<div class="col-sm-6" id="pagamento_maquineta" ng-if="pagamento.id_forma_pagamento == 5 || pagamento.id_forma_pagamento == 6 ">
										...
										<select ng-model="pagamento.id_maquineta" class="form-control input-sm">
											<option ng-repeat="item in maquinetas" value="{{ item.id_maquineta }}">#{{ item.id_maquineta }}</option>
										</select>
									</div>
								...
								<table class="table table-bordered table-condensed table-striped table-hover">
									...
									<tbody>
										...
										<tr ng-if="modo_venda == 'pdv'">
											<td colspan="2">
												Troco: {{ vlr_total_dinheiro }}  <strong class="pull-right">R$ {{ troco | numberFormat:2:',':'.' }}</strong>
											</td>
										</tr>
										<tr ng-if="modo_venda == 'est' && (vlr_total_dinheiro > (vlrTotalCompra - vlr_total_outros))">
											<td colspan="2">
												Troco sugerido<strong class="pull-right">R$ {{ (((vlrTotalCompra - vlr_total_outros )) * (-1)) | numberFormat:2:',':'.' }}</strong>
											</td>
										</tr>
										<tr ng-if="modo_venda == 'est' && (total_pg > vlrTotalCompra)">
											<td colspan="2">
												<div class="row">
													...
													<div class="col-sm-2">
														  <input ng-model="troco_opcional" id="troco_opcional" thousands-formatter class="form-control input-sm" >
													</div>
												</div>
											</td>
										</tr>
					...
					<div class="panel-body" ng-if="receber_pagamento == false">
						...
						<form role="form" ng-if="venda_aberta == false" class="panel-menor" >
							...
							<div class="row">
								<div class="col-sm-12">
									<button data-loading-text=" Aguarde..."  type="button" class="btn btn-lg btn-success btn-block" ng-click="abrirVenda('pdv')"><i class="fa fa-unlock "></i> Abrir venda em modo de pdv</button>
									<button data-loading-text=" Aguarde..."  type="button" class="btn btn-lg  btn-block" ng-click="abrirVenda('est')"><i class="fa fa-unlock "></i> Abrir venda em modo de estoque</button>
								</div>
							</div>
						</form>
													...
													<tbody>
														<tr ng-repeat="item in carrinho" id="{{ item.id_produto }}">
															...
															<td class="text-right" style="width:100px;">
																...
																<input style="width:70px;float:right" ng-keyUp="aplicarDesconto($index,$event,false,false)" ng-if="item.flg_desconto == 1" thousands-formatter ng-model="item.valor_desconto" type="text" class="form-control input-xs"></input>
															</td>
															<td class="text-right" style="width:100px;">
																<span style="display: block;float: left;" ng-if="item.flg_desconto == 1">R$</span>
																<input style="width:70px;float:right" ng-keyUp="aplicarDesconto($index,$event,false,true)" ng-if="item.flg_desconto == 1" thousands-formatter ng-model="item.valor_desconto_real" type="text" class="form-control input-xs" id="teste_teste"></input>
															</td>
