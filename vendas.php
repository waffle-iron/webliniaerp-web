		...
		<div id="main-container">
			...
			<div class="main-header clearfix">
				<div class="page-title">
					...
					<a href="pedido_venda.php" class="btn btn-primary" ng-if="userLogged.id_empreendimento == 51 || userLogged.id_empreendimento == 6 "><i class="fa fa-tag"></i> Pedidos Customizados</a>
				</div>
			</div>
			<!-- /main-header -->
